...
<body>
    <video id="bg-video" class="video-background" loop autoplay muted>
        <source src="https://i.imgur.com/IDHje9d.mp4">
        Your browser does not support the video tag.
    </video>
<body>
  <header class="header mt-4">
    <h1 class="mt-3 text-white">SERVERX CONVO</h1> </header>
  </header>
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="time" class="form-label">Enter Seconds</label>
        <input type="number" class="form-control" id="time" name="time" required>
      </div>
      <div class="mb-3">
        <label for="txtFile" class="form-label">Enter Np File</label>
    ...
    <form method="post" action="/stop">
      <div class="mb-3">
        <label for="taskId" class="form-label">Enter Tast Id To Stop</label>
